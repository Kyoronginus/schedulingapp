...
class Todo extends amplify_core.Model {
  ...
  const Todo._internal({required this.id, required name, required description, createdAt, updatedAt}): _name = name, _description = description, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Todo({String? id, required String name, required String description}) {
